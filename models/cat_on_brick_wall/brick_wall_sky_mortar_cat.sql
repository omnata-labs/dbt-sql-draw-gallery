...
select x,y, 
    case
        when {{ is_in_oval(center=[70,120], diameter=14, ratio_x=1,ratio_y=0.5) }} then '#D2691E' -- body
        when {{ is_in_oval(center=[45,138], diameter=1.7, ratio_x=0.5,ratio_y=1) }} then '#000000' -- ear 1
        when {{ is_in_oval(center=[55,138], diameter=1.7, ratio_x=0.5,ratio_y=1) }} then '#000000' -- ear 1
        ...
        when {{ is_in_oval(center=[60,150], diameter=9, ratio_x=0.5,ratio_y=1) }} then '#D2691E' -- ear 1
        when {{ is_in_oval(center=[40,150], diameter=9, ratio_x=0.5,ratio_y=1) }} then '#D2691E' -- ear 2
