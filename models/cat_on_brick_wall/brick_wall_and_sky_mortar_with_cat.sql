...
select x,y, 
    case
        ...
        when {{ rectangle(bottom_left=[45,100], top_right=[50,120])}} then '#D2691E' -- leg 1
        when {{ rectangle(bottom_left=[55,100], top_right=[60,120])}} then '#D2691E' -- leg 2
        when {{ rectangle(bottom_left=[80,100], top_right=[85,120])}} then '#D2691E' -- leg 3
        when {{ rectangle(bottom_left=[90,100], top_right=[95,120])}} then '#D2691E' -- leg 4
